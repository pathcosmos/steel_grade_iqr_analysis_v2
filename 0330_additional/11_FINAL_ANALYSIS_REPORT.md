...
| MAIN_GAS_FLOW | N5 | 1,191 ~ 2,932 | 1,326 | -40.6% | 가스 유량 감소 |
| MAIN_GAS_FLOW | D5 | 938 ~ 2,477 | 1,629 | -13.7% | 약한 감소 |
| PR3 토크 | D5 | 25 ~ 100 | 89.8 | +87.6% | 과도하게 높음 |
| PR3 토크 | N5 | 35 ~ 100 | 72.3 | +41.5% | 높음 |
| Stand 8 토크 | D4 | 2.7 ~ 45.5 | 20.3 | -43.9% | 토크 부족 |
| Stand 8 토크 | N5 | 2.4 ~ 45.4 | 20.0 | -40.6% | 토크 부족 |
...
| 태그 | avg rho | avg p-value | std rho | std p-value | 판정 |
|------|:-------:|:-----------:|:-------:|:-----------:|:----:|
| Stand 14 토크 | 0.087 | 0.334 (n.s.) | **0.351** | 0.00005 (\*\*\*) | std만 유의 |
| FB Slave 토크 | - | - | **0.491** | <0.001 (\*\*\*) | ML 1위 태그 |
| FB Master 토크 | 0.322 | 0.0002 (\*\*\*) | 0.491 | <0.001 (\*\*\*) | 둘 다 유의 |
...
| Stand 14 토크 std | 0.351 (\*\*\*) | 0.308 (\*\*\*) | 0.163 (n.s.) |

→ FB Slave std: 모든 유형에서 유의 / Stand 14 std: 중량불량에서만 비유의
...
| 순위 | 태그 | Mean SHAP |
|:----:|------|:---------:|
| 1 | FB_SLAVE_TORQUE_std | 0.0095 |
| 2 | WASTE_GAS_PRESSURE_min | 0.0082 |
| 3 | PR3_REF_TORQUE_std | 0.0075 |
| 4 | PR3_REF_TORQUE_std_delta5 | 0.0068 |
...
| FB Slave 토크 | - | - | **0.491** | <0.001 (\*\*\*) | ML 1위 태그 |
| FB Master 토크 | 0.322 | 0.0002 (\*\*\*) | 0.491 | <0.001 (\*\*\*) | 둘 다 유의 |
| Stand 14 속도 | 0.202 | 0.023 (\*) | 0.363 | 0.00003 (\*\*\*) | std 더 강함 |
