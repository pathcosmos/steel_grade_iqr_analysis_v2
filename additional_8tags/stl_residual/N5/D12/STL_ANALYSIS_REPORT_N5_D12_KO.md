...
|------|------|----------|----------|-------------|-------------|
| 1 | PINCHROLL_4_ACTUAL_SPEED | 핀치롤 | 43.49% | 0.000 | none |
| 2 | PINCHROLL_3_ACTUAL_SPEED | 핀치롤 | 43.39% | 0.010 | none |
| 3 | PR7L1_ACT_SPD_MS | PR 상세 (토크+속도) | 42.91% | 0.000 | none |
| 4 | PINCHROLL_3_REFERENCE_SPEED | 핀치롤 | 42.42% | 0.000 | none |
| 5 | PR8L1_ACT_SPD_MS | PR 상세 (토크+속도) | 42.08% | 0.000 | none |
| 6 | PINCHROLL_4_REFERENCE_SPEED | 핀치롤 | 42.05% | 0.000 | none |
| 7 | PR9L1_ACT_TORQUE | PR 상세 (토크+속도) | 41.46% | 0.078 | none |
| 8 | PR9L1_ACT_SPD_MS | PR 상세 (토크+속도) | 41.46% | 0.000 | none |
| 9 | PINCHROLL_3_ACTUAL_TORQUE | 핀치롤 | 41.43% | 0.075 | none |
| 10 | PINCHROLL_4_REFERENCE_TORQUE | 핀치롤 | 41.18% | 0.000 | none |
| 11 | PR7L2_ACT_TORQUE | PR 상세 (토크+속도) | 40.67% | 0.000 | none |
| 12 | PR7L2_ACT_SPD_MS | PR 상세 (토크+속도) | 40.56% | 0.000 | none |
| 13 | PR7L1_ACT_TORQUE | PR 상세 (토크+속도) | 40.36% | 0.016 | none |
| 14 | PR6L1_ACT_TORQUE | PR 상세 (토크+속도) | 40.22% | 0.016 | none |
| 15 | PINCHROLL_2_ACTUAL_TORQUE | 핀치롤 | 39.98% | 0.000 | none |
...
| PINCHROLL_3_REFERENCE_SPEED | 42.42% | 0.000 | 0.805 |
| PINCHROLL_4_REFERENCE_SPEED | 42.05% | 0.000 | 0.929 |
...
**PINCHROLL_3_REFERENCE_SPEED** (이상치율: 42.42%, 계절성: 0.000)
...
| 태그 | 이상치율 | 계절성 강도 | 추세 강도 |
|------|----------|-------------|-----------|
| PR6L1_ACT_TORQUE | 40.22% | 0.016 | 0.952 |
| PR6L2_ACT_TORQUE | 39.98% | 0.000 | 0.970 |
| PR7L1_ACT_TORQUE | 40.36% | 0.016 | 0.974 |
| PR7L2_ACT_TORQUE | 40.67% | 0.000 | 0.958 |
| PR8L1_ACT_TORQUE | 39.50% | 0.198 | 0.921 |
| PR9L1_ACT_TORQUE | 41.46% | 0.078 | 0.956 |
| PR6L1_ACT_SPD_MS | 35.78% | 0.187 | 0.988 |
| PR6L2_ACT_SPD_MS | 38.88% | 0.000 | 0.954 |
| PR7L1_ACT_SPD_MS | 42.91% | 0.000 | 0.968 |
| PR7L2_ACT_SPD_MS | 40.56% | 0.000 | 0.941 |
| PR8L1_ACT_SPD_MS | 42.08% | 0.000 | 0.966 |
| PR9L1_ACT_SPD_MS | 41.46% | 0.000 | 0.933 |

#### STL 분해 차트

**PR7L1_ACT_SPD_MS** (이상치율: 42.91%, 계절성: 0.000)

![PR7L1_ACT_SPD_MS](09_PR_Detailed/PR7L1_ACT_SPD_MS_stl_decomposition.png)

**PR8L1_ACT_SPD_MS** (이상치율: 42.08%, 계절성: 0.000)

![PR8L1_ACT_SPD_MS](09_PR_Detailed/PR8L1_ACT_SPD_MS_stl_decomposition.png)

**PR9L1_ACT_TORQUE** (이상치율: 41.46%, 계절성: 0.078)
