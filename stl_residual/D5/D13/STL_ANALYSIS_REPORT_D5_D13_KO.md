...
|------|------|----------|----------|-------------|-------------|
| 1 | PINCHROLL_2_ACTUAL_TORQUE | 핀치롤 | 47.37% | 0.612 | moderate |
| 2 | PR8L1_ACT_TORQUE | PR 상세 (토크+속도) | 45.44% | 0.000 | none |
| 3 | PR7L2_ACT_SPD_MS | PR 상세 (토크+속도) | 44.80% | 0.993 | strong |
| 4 | PINCHROLL_3_ACTUAL_TORQUE | 핀치롤 | 43.87% | 0.000 | none |
| 5 | PINCHROLL_4_ACTUAL_TORQUE | 핀치롤 | 43.78% | 0.000 | none |
| 6 | PINCHROLL_2_REFERENCE_TORQUE | 핀치롤 | 43.69% | 0.078 | none |
| 7 | PR8L1_ACT_SPD_MS | PR 상세 (토크+속도) | 43.67% | 0.022 | none |
| 8 | PR6L2_ACT_TORQUE | PR 상세 (토크+속도) | 43.21% | 0.185 | none |
| 9 | PINCHROLL_4_ACTUAL_SPEED | 핀치롤 | 42.79% | 0.362 | weak |
| 10 | PR9L1_ACT_SPD_MS | PR 상세 (토크+속도) | 42.17% | 0.142 | none |
| 11 | PR6L1_ACT_SPD_MS | PR 상세 (토크+속도) | 41.90% | 0.000 | none |
| 12 | PINCHROLL_3_REFERENCE_TORQUE | 핀치롤 | 41.88% | 0.000 | none |
| 13 | PINCHROLL_3_ACTUAL_SPEED | 핀치롤 | 40.74% | 0.261 | weak |
| 14 | PR6L1_ACT_TORQUE | PR 상세 (토크+속도) | 40.72% | 0.002 | none |
| 15 | PINCHROLL_2_ACTUAL_SPEED | 핀치롤 | 40.29% | 0.211 | weak |
...
|------|----------|-------------|---------------|
| PR7L2_ACT_SPD_MS | PR 상세 (토크+속도) | 0.993 | 44.80% |
...
| PINCHROLL_3_REFERENCE_SPEED | 38.11% | 0.024 | 0.974 |
| PINCHROLL_4_REFERENCE_SPEED | 33.76% | 0.000 | 0.999 |
...
| 태그 | 이상치율 | 계절성 강도 | 추세 강도 |
|------|----------|-------------|-----------|
| PR6L1_ACT_TORQUE | 40.72% | 0.002 | 0.249 |
| PR6L2_ACT_TORQUE | 43.21% | 0.185 | 0.999 |
| PR7L1_ACT_TORQUE | 38.86% | 0.000 | 0.748 |
| PR7L2_ACT_TORQUE | 33.41% | 0.000 | 0.952 |
| PR8L1_ACT_TORQUE | 45.44% | 0.000 | 0.000 |
| PR9L1_ACT_TORQUE | 37.00% | 0.000 | 0.969 |
| PR6L1_ACT_SPD_MS | 41.90% | 0.000 | 0.999 |
| PR6L2_ACT_SPD_MS | 37.95% | 0.432 | 1.000 |
| PR7L1_ACT_SPD_MS | 39.72% | 0.065 | 0.963 |
| PR7L2_ACT_SPD_MS | 44.80% | 0.993 | 1.000 |
| PR8L1_ACT_SPD_MS | 43.67% | 0.022 | 0.944 |
| PR9L1_ACT_SPD_MS | 42.17% | 0.142 | 0.973 |

#### STL 분해 차트

**PR8L1_ACT_TORQUE** (이상치율: 45.44%, 계절성: 0.000)

![PR8L1_ACT_TORQUE](09_PR_Detailed/PR8L1_ACT_TORQUE_stl_decomposition.png)

**PR7L2_ACT_SPD_MS** (이상치율: 44.80%, 계절성: 0.993)

![PR7L2_ACT_SPD_MS](09_PR_Detailed/PR7L2_ACT_SPD_MS_stl_decomposition.png)

**PR8L1_ACT_SPD_MS** (이상치율: 43.67%, 계절성: 0.022)
