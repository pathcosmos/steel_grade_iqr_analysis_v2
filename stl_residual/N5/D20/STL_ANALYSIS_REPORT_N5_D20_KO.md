...
|------|------|----------|----------|-------------|-------------|
| 1 | PR7L2_ACT_TORQUE | PR 상세 (토크+속도) | 45.84% | 0.000 | none |
| 2 | PINCHROLL_3_REFERENCE_SPEED | 핀치롤 | 43.22% | 0.000 | none |
| 3 | PINCHROLL_4_ACTUAL_TORQUE | 핀치롤 | 43.16% | 0.095 | none |
| 4 | PINCHROLL_3_ACTUAL_SPEED | 핀치롤 | 42.80% | 0.000 | none |
| 5 | PINCHROLL_4_ACTUAL_SPEED | 핀치롤 | 42.61% | 0.000 | none |
| 6 | PR6L2_ACT_TORQUE | PR 상세 (토크+속도) | 41.40% | 0.000 | none |
| 7 | PR7L2_ACT_SPD_MS | PR 상세 (토크+속도) | 40.91% | 0.009 | none |
| 8 | PINCHROLL_4_REFERENCE_SPEED | 핀치롤 | 40.55% | 0.055 | none |
| 9 | PINCHROLL_2_ACTUAL_SPEED | 핀치롤 | 39.45% | 0.033 | none |
| 10 | PR6L1_ACT_TORQUE | PR 상세 (토크+속도) | 37.39% | 0.006 | none |
| 11 | PR9L1_ACT_TORQUE | PR 상세 (토크+속도) | 37.14% | 0.015 | none |
| 12 | PR6L1_ACT_SPD_MS | PR 상세 (토크+속도) | 37.08% | 0.000 | none |
| 13 | PINCHROLL_4_REFERENCE_TORQUE | 핀치롤 | 36.90% | 0.066 | none |
| 14 | PINCHROLL_2_ACTUAL_TORQUE | 핀치롤 | 34.95% | 0.000 | none |
| 15 | PR8L1_ACT_TORQUE | PR 상세 (토크+속도) | 34.83% | 0.001 | none |
...
| PINCHROLL_3_REFERENCE_SPEED | 43.22% | 0.000 | 0.952 |
| PINCHROLL_4_REFERENCE_SPEED | 40.55% | 0.055 | 0.995 |

#### STL 분해 차트

**PINCHROLL_3_REFERENCE_SPEED** (이상치율: 43.22%, 계절성: 0.000)
...
| 태그 | 이상치율 | 계절성 강도 | 추세 강도 |
|------|----------|-------------|-----------|
| PR6L1_ACT_TORQUE | 37.39% | 0.006 | 0.843 |
| PR6L2_ACT_TORQUE | 41.40% | 0.000 | 0.986 |
| PR7L1_ACT_TORQUE | 34.65% | 0.028 | 0.986 |
| PR7L2_ACT_TORQUE | 45.84% | 0.000 | 0.994 |
| PR8L1_ACT_TORQUE | 34.83% | 0.001 | 0.891 |
| PR9L1_ACT_TORQUE | 37.14% | 0.015 | 0.873 |
| PR6L1_ACT_SPD_MS | 37.08% | 0.000 | 0.961 |
| PR6L2_ACT_SPD_MS | 34.47% | 0.000 | 0.963 |
| PR7L1_ACT_SPD_MS | 27.96% | 0.000 | 0.961 |
| PR7L2_ACT_SPD_MS | 40.91% | 0.009 | 0.956 |
| PR8L1_ACT_SPD_MS | 20.61% | 0.009 | 0.989 |
| PR9L1_ACT_SPD_MS | 32.16% | 0.000 | 0.993 |

#### STL 분해 차트

**PR7L2_ACT_TORQUE** (이상치율: 45.84%, 계절성: 0.000)

![PR7L2_ACT_TORQUE](09_PR_Detailed/PR7L2_ACT_TORQUE_stl_decomposition.png)

**PR6L2_ACT_TORQUE** (이상치율: 41.40%, 계절성: 0.000)

![PR6L2_ACT_TORQUE](09_PR_Detailed/PR6L2_ACT_TORQUE_stl_decomposition.png)

**PR7L2_ACT_SPD_MS** (이상치율: 40.91%, 계절성: 0.009)
