...
| 7 | PR7L2_ACT_TORQUE | PR 상세 토크 | 31.94% | 0.008 | none |
| 8 | STAND_13_ACTUAL_SPEED | 스탠드 속도 | 31.48% | 0.022 | none |
| 9 | PINCHROLL_4_ACTUAL_TORQUE | 핀치롤 | 31.48% | 0.000 | none |
| 10 | STAND_12_ACTUAL_SPEED | 스탠드 속도 | 30.09% | 0.026 | none |
| 11 | STAND_6_LOAD | 스탠드 부하 | 30.09% | 0.000 | none |
| 12 | STAND_7_LOAD | 스탠드 부하 | 30.09% | 0.000 | none |
| 13 | STAND_8_LOAD | 스탠드 부하 | 30.09% | 0.000 | none |
| 14 | STAND_5_LOAD | 스탠드 부하 | 29.63% | 0.000 | none |
| 15 | STAND_9_LOAD | 스탠드 부하 | 29.63% | 0.000 | none |
...
| 태그 | 이상치율 | 계절성 강도 | 추세 강도 |
|------|----------|-------------|-----------|
| PR6L2_ACT_TORQUE | 18.98% | 0.040 | 0.936 |
| PR7L2_ACT_TORQUE | 31.94% | 0.008 | 0.869 |

#### STL 분해 차트

**PR7L2_ACT_TORQUE** (이상치율: 31.94%, 계절성: 0.008)

![PR7L2_ACT_TORQUE](09_PR_Detailed/PR7L2_ACT_TORQUE_stl_decomposition.png)

**PR6L2_ACT_TORQUE** (이상치율: 18.98%, 계절성: 0.040)
